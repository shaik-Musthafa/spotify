...
const moreArtists = document.getElementById('more-artists');
if (moreArtists.style.display === 'none') {
    moreArtists.style.display = 'block'; // Show additional artists
    this.textContent = 'Show Less Artists'; // Change link text
} else {
    moreArtists.style.display = 'none'; // Hide additional artists
    this.textContent = 'Show All Artists'; // Reset link text
}
});